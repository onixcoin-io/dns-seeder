...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Onix-seeder\n"
    ...
    do {
        ...
        if (fStaticIPs4.good())
        {
            ...
            while (std::getline(fStaticIPs4, line))
            {
                ...
                db.Add(CAddress(CService(line+":5888"), true));
                printf("%s", line.c_str());
            }
        }
...
static const string mainnet_seeds[] = {"s1.onixcrypto.com", "s2.onixcrypto.com", "s3.onixcrypto.com", ""};
static const string testnet_seeds[] = {"s1.onixcrypto.com", "s2.onixcrypto.com", "s3.onixcrypto.com", ""};
